#' Predictive Accuracy Testing for Nested Environment \bar{S}
#'
#' It calculates the \bar{S} statistics for nested models with null hypothesis being the two models having equal predictive power following Pitarakis (2023).
#' There are in total four versions of \bar{S}, based on the assumptions of variance (homo or hete) and residuals (original or adjusted).
#' All \bar{S} statistics will be standarised to a standard N(0,1) normal distribution, and corresponding P values would be provided.
#' 
...
#' @return A list of \bar{S} statistics and corresponding P values will be produced. "adj" means a Clark and West's (2007) reformulation of sample MSE has been applied
...
Nested_Stats_Sbar=function(Ehat1,Ehat2,lam20,tau0){
  ...
  pv_Sbar_tau0_lam20 = 1-pnorm(Sbar_tau0_lam20) 
  pv_Sbar_tau0_lam20_adj = 1-pnorm(Sbar_tau0_lam20_adj) 
  ...
  pv_Sbar_tau0_lam20_NW = 1-pnorm(Sbar_tau0_lam20_NW)
  pv_Sbar_tau0_lam20_adj_NW = 1-pnorm(Sbar_tau0_lam20_adj_NW)
