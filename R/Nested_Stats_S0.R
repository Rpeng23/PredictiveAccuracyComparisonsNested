...
Nested_Stats_S0=function(Ehat1,Ehat2,lam10,lam20){
  ...
  pv_S_lam10_lam20 = 1-pnorm(S_lam10_lam20)
  pv_S_lam10_lam20_adj = 1-pnorm(S_lam10_lam20_adj)
  
  pv_S_lam10_lam20_NW = 1-pnorm(S_lam10_lam20_NW)
  pv_S_lam10_lam20_adj_NW = 1-pnorm(S_lam10_lam20_adj_NW)
