...
#' @param nleg Non-negative integer containing the lag length to use. If empty or not included,
...
lr_var = function(u,nlag=min(floor(1.2*dim(u)[1]^(1/3)),dim(u)[1]),demean=TRUE){
